...
def get_bert_biencoder_components(cfg, inference_only: bool = False, **kwargs):
    ...
    # Quick fix on old checkpoint version
    if "bertModel" in cfg.encoder.pretrained_model_cfg:
    ...
    if cfg.train.shared_encoder:
        biencoder = BiEncoder(cfg, question_encoder, question_encoder, fix_ctx_encoder=fix_ctx_encoder)
    else: 
...
class BertTensorizer(Tensorizer):
    ...
    def text_to_tensor(
        ...
        seq_len = max_len #self.max_length
